            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="<%=rootPath %>/dist/img/user4-128x128.jpg" alt="user image" class="online" />
                    ...
                    <p class="message">
                      ...
                      I would like to meet you to discuss the latest news about the arrival of the new theme. They say it is going to be one the best
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="<%=rootPath %>/dist/img/user3-128x128.jpg" alt="user image" class="offline" />
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="<%=rootPath %>/dist/img/user2-160x160.jpg" alt="user image" class="offline" />
