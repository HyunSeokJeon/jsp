  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="pages/examples/gallery.html"><i class="fa fa-circle-o"></i> ê°¤ë¬ë¦¬</a>
                </li>
                <li>
                  <a href="pages/examples/news.html"><i class="fa fa-circle-o"></i> ì°í©ë´ì¤</a>
                </li>
                <li>
                  <a href="pages/examples/normalboard.html"
                    ><i class="fa fa-circle-o"></i> ì¼ë°ê²ìí</a
                  >
                </li>
                <li>
        ...
        <div id="visual">
          <div id="mySwipe" class="swipe">
            <ul class="touch_banner swipe-wrap">
              <!--Â ë°°ë ëª©ë¡Â -->
              <li>
                <a href="#"><img src="dist/img/images/visual_img_1.jpg" alt="" /></a>
              </li>
              <li>
                <a href="#"><img src="dist/img/images/visual_img_2.jpg" alt="" /></a>
              </li>
              <li>
                <a href="#"><img src="dist/img/images/visual_img_3.jpg" alt="" /></a>
              </li>
            </ul>
          </div>
          <ul class="touch_bullet">
            <!--Â ë°°ë ìì¹ íìÂ -->
            <li><img src="dist/img/images/visual_bullet_on.png" class="active" alt="" /></li>
            <li><img src="dist/img/images/visual_bullet_off.png" alt="" /></li>
            <li><img src="dist/img/images/visual_bullet_off.png" alt="" /></li>
          </ul>
          <p class="touch_left_btn">
            <!--Â ì´ì  ë²í¼Â -->
            <a href="#">
              <img src="dist/img/images/visual_btn_left.png" alt="ì´ì  ë°°ë" />
            </a>
          </p>
          <p class="touch_right_btn">
            <!--Â ì´ì  ë²í¼Â -->
            <a href="#">
              <img src="dist/img/images/visual_btn_right.png" alt="ë¤ì ë°°ë" />
            </a>
          </p>
        </div>
        <!-- Main content -->
                ...
                <div class="box-body">
                  <ul class="products-list product-list-in-box">
                    <li class="item">
                      ...
                      <div class="product-info">
                        <a href="javascript:void(0)" class="product-title"
                          >Samsung TV <span class="label label-warning pull-right">$1800</span></a
                        >
                    ...
                    <li class="item">
                      ...
                      <div class="product-info">
                        <a href="javascript:void(0)" class="product-title"
                          >Bicycle <span class="label label-info pull-right">$700</span></a
                        >
                        <span class="product-description">
                    ...
                    <li class="item">
                      ...
                      <div class="product-info">
                        <a href="javascript:void(0)" class="product-title"
                          >Xbox One <span class="label label-danger pull-right">$350</span></a
                        >
                        <span class="product-description">
                    ...
                    <li class="item">
                      ...
                      <div class="product-info">
                        <a href="javascript:void(0)" class="product-title"
                          >PlayStation 4 <span class="label label-success pull-right">$399</span></a
                        >
      ...
      <footer class="main-footer">
        ...
        <strong
          >Copyright &copy; 2014-2016 <a href="https://adminlte.io">Almsaeed Studio</a>.</strong
        >
        All rights reserved.
      </footer>
