  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>GOING</b> life mall</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="loginprocess.jsp" method="post" id="loginForm" onsubmit="return go2();">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat" id="loginSubmit">로그인</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
    ...
    <!-- <script>
      ...
      function login(id, pw) {
        if (id == "hanguk@naver.com") {
          if (pw == "1234") {
            alert(id + "ë ë°©ë¬¸ì íìí©ëë¤");
          } else {
            alert("ìëª»ë ë¹ë°ë²í¸ìëë¤.");
            return false;
          }
        } else {
