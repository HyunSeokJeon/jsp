...
<% String viewPath = request.getContextPath(); %>
<html>
  <head>
    <meta charset="utf-8" />
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<%=rootPath %>/index2.html"><b>GOING</b> life mall</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<%=viewPath %>/login.do" method="post" id="loginForm" onsubmit="return go2();">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat" id="loginSubmit">sing in</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
